...
## About Me
QA & Test Automation Engineer with a passion for software quality, automation, and continuous learning. My experience covers functional testing, test automation, API testing, defect management, performance and security testing. I work with tools and technologies such as **Robot Framework**, **Selenium**, **Postman**, **REST Assured**, **Java**, **SQL**, and **JMeter**. I also have a strong background in web development which helps me better understand application architectures, design effective test strategies, and collaborate efficiently with development teams. ISTQB Foundation Level certified, I enjoy building reliable test solutions and contributing to the delivery of high-quality software in Agile environments.
...
![Robot Framework with Python- Selenium/API Automation Testing](https://img.shields.io/badge/Robot Framework with Python- Selenium/API Automation Testing-Udemy-black?style=for-the-badge)
